...
class DeleteExpiredNairaInvestments extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:delete-expired-naira-investments';
    ...
    public function handle()
    {
        ...
        $expiredInvestments = InvestmentNaira1::where('end_date', '<=',$currentDate)->get();
        // return ; 
